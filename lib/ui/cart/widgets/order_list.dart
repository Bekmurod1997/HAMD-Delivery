    ...
    return Obx(
      () {
        if (cartListController.isLoading.value) {
          ...
          return cartListController.allCartList.length > 0 ||
              ...
              ? ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    String productName =
                        cartListController.allCartList[index].productName;
                    var myArr = productName.split(' ');
                    return Stack(
                      children: [
                        Dismissible(
                          direction: DismissDirection.endToStart,
                          key: Key(cartListController
                            ...
                            if (direction == DismissDirection.endToStart) {
                              final bool res = await showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      content: Text("arySureToDelete".tr),
                                      actions: <Widget>[
                                        FlatButton(
                                          child: Text(
                                            "cancel".tr,
